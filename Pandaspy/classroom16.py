...
print(df1["QT_SALAS_UTILIZADAS_FORA"] + df1["QT_SALAS_UTILIZADAS_DENTRO"])

# Vai dar um MEMORY ERROR
# print(df1[["QT_SALAS_UTILIZADAS_FORA", "QT_SALAS_UTILIZADAS_DENTRO"]] /  df1["QT_SALAS_EXISTENTES"])
print(df1[["QT_SALAS_UTILIZADAS_FORA", "QT_SALAS_UTILIZADAS_DENTRO"]].divide(df1["QT_SALAS_UTILIZADAS"], axis="rows"))