...
print(df3.reindex(columns=["ID_ESCOLA", "ANO", "IDEB_AI", "IDEB_AF"]).fillna(-1))
print(df3.reindex(columns=["ID_ESCOLA", "ANO", "IDEB_AI", "IDEB_AF"]).ffill())
print(df3.reindex(columns=["ID_ESCOLA", "ANO", "IDEB_AI", "IDEB_AF"]).bfill())
print(df3.reindex(columns=["IDEB_AI", "IDEB_AF"]).ffill(axis=1))